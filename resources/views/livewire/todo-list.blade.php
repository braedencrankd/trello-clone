<div class="flex flex-col gap-5">
	...
	<x-sortable class="grid min-w-[24rem] gap-4"
		...
		@foreach ($this->todos as $todo)
			<x-sortable.item
				class="border-opacity-45 group flex items-center justify-between rounded-full border border-indigo-400 bg-white p-1 px-2.5 py-2 shadow dark:bg-slate-900"
				:key="$todo->id">
